...
INSERT INTO `customer` (customer_id, customer_ip, customer_name, customer_email, customer_pass, customer_country, customer_city, customer_contact, customer_address) 
VALUES (NULL,'127.0.0.1','John Cena','JCena@gmail.com','pass123','US','NYC','1234','123 example street');


INSERT INTO Inventory (product_id, reserve) 
VALUES
('Apple iPhone 7', 10),
('Samsung S7', 4),
('LG', 6);